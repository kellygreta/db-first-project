        ...
        <?php
         ...
         $conn = pg_connect("host=localhost port=5432 dbname=GestionePiscine user=postgres password=postgres");
            ...
            if (!$conn) {
                ...
                $id = $_POST['selezionaEdizione'];
                $query = "DELETE FROM edizione WHERE id = '$id'";

                $result = pg_query($conn, $query);
                if($result){
                    echo("<br>Edizione eliminata con successo!<br><br>");
                } else{
                    echo("<br>Edizione NON eliminato correttamente.<br><br>");
                }
