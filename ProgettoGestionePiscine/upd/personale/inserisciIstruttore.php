        ...
        <?php
         ...
         $conn = pg_connect("host=localhost port=5432 dbname=GestionePiscine user=postgres password=postgres");
            ...
            if (!$conn) {
                ...
                $query = "INSERT INTO Istruttore (cf, nome, cognome, datanascita)
                            VALUES ('$cf', '$nome', '$cognome', '$datanascita')";

                $result = pg_query($conn, $query);
                if($result){
                    echo("<br>Istruttore inserito correttamente!<br><br>");
                } else{
                    echo("<br>Istruttore NON inserito correttamente.<br><br>");
                }
