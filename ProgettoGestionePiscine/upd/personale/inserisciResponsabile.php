        ...
        <?php
         ...
         $conn = pg_connect("host=localhost port=5432 dbname=GestionePiscine user=postgres password=postgres");
            ...
            if (!$conn) {
                ...
                $query = "INSERT INTO Responsabile (cf, nome, cognome, datanascita)
                            VALUES ('$cf', '$nome', '$cognome', '$datanascita')";

                $result = pg_query($conn, $query);
                if($result){
                    echo("<br>Responsabile inserito correttamente!<br><br>");
                } else{
                    echo("<br>Responsabile NON inserito correttamente.<br><br>");
                }
