        ...
        <?php
         ...
         $conn = pg_connect("host=localhost port=5432 dbname=GestionePiscine user=postgres password=postgres");
            ...
            if (!$conn) {
                ...
                $cf = $_POST['selezionaResponsabile'];
                $query = "DELETE FROM responsabile WHERE cf = '$cf'";

                $result = pg_query($conn, $query);
                if($result){
                    echo("<br>Responsabile eliminato con successo!<br><br>");
                } else{
                    echo("<br>Responsabile NON eliminato correttamente.<br><br>");
                }
